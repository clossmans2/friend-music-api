        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LikedPlaylist_People_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnedPlaylist", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OwnedPlaylist_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OwnedPlaylist_Playlists_PlaylistId",
                        column: x => x.PlaylistId,
                        principalTable: "Playlists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikedPlaylist_PersonId",
                table: "LikedPlaylist",
                column: "PersonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OwnedPlaylist_PersonId",
                table: "OwnedPlaylist",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_OwnedPlaylist_PlaylistId",
                table: "OwnedPlaylist",
                column: "PlaylistId");
